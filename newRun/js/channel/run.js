	...
	*/
	...
	function onBridgeReady() {
		var t = new Date().getTime(),
		    ...
		    mainURL="http://dev.hotkeypower.com/lfhtml/run5/views/run.html?v12",
		    mainImgUrl= "http://dev.hotkeypower.com/lfhtml/run5/images/run_share.jpg";
